%io_writerda_modified.m
%Georg Oeltzschner, Johns Hopkins University 2019.
%Heiner N. Raum, UKM Münster 2024 (NormTra added).
%
% USAGE:
...
function RF=io_writedata_modified(in,outfile);
...
%modified HR
fprintf(fid,'VOINormalTra: %4.6f\r\n', in.geometry.rot.NormTra);
%
